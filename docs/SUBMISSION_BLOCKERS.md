...
State it with its control, or it overstates: severe-class (class 4) TSTR F1 is 0.000 for every
generator — **and TRTR F1 is 0.000 too**, as it is for classes 2 and 3 under both protocols. The
real-data baseline is equally unable to produce a usable minority-class F1, so this is a property of
the class imbalance, not of synthetic data. The measure that separates them is class-4 AUC: TRTR
0.765, CTGAN TSTR 0.566, GaussianCopula TSTR **0.391 — below chance**.
